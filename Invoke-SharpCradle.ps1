...
# Create an argument list dynamically
$argList = @($uri, $argument1, $argument2, $argument3, $argument4, $argument5, $argument6, $argument7, $argument8, $argument9, $argument10, $argument11, $argument12, $argument13, $argument14, $argument15).Where({$_ -ne $null})

# Call the Main method with dynamic arguments
[SharpCradle.Program]::Main($argList)
}
